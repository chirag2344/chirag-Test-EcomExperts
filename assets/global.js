...
$(document).on("change",".block__product-size-variant select",function(){
  var value = $(this).val();
  $(".product-form__input").find("input[value='"+value+"']").trigger("click");
});

$(document).on("click",".variant_product label img",function(){
  var value = $(this).attr("color_name");
  $(".product-form__input").find("input[value='"+value+"']").trigger("click");
});